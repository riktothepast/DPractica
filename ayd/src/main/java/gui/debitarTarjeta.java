...
public class debitarTarjeta {
	JFrame jf;
	public debitarTarjeta(){
	
	}	
	
	public void init(){
		jf=new JFrame("debitar tarjeta");
		...
		but1.setText("debitar tarjeta");
		but1.setSize(600, 100);
		but1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {
            	cSaldo(jtx.getText(),null);
            }
        });      
		jf.add(but1);
	...
	public String cSaldo(String ar1,String ar2){
		...
		ar2=ar2.trim();
		String uri =
			    "http://localhost:3000/charge_card/?id="+ar1;
			URL url = null;
			try {
				url = new URL(uri);
